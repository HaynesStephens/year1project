...
def quiverPlot(col, ax, tit_ad, num_files = 10, filetype='oijl', unit_conv=0.1, depth=0):
    ...
    q = m.quiver(x, y, u, v, ax=ax, scale_units='width', units='width', scale=72, width=0.001, headwidth=5, headlength=4)
    ax.quiverkey(q, X=0.93, Y=1.02, U=10, label = '10 m/s', labelpos = 'E')
