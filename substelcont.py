...
fdir = '26p'
fbase_name = '.ssc.latpn38.lonpn72_5.26p.nc'

lat = 40 # lat given from spreadsheet that outlines ACTUAL continent, NOT from GRID coords (see spreadsheet)
...
lon = 75 # lat given from spreadsheet that outlines ACTUAL continent, NOT from GRID coords (see spreadsheet)
         # https://docs.google.com/spreadsheets/d/1Cp85DWFq9kVjZ96rZPasCS9Nhny64671wVQjHS_XUNI/edit#gid=0
         # you can see in the fbase_name that the GRID coordinates are given there, and they are
         # different from the ACTUAL coordinates
lon_lo = (lon - 2.5) * (-1)
