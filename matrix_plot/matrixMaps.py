...
def makeSubplot(data, var, ax, row_num, col_num, ylabel, parallels, meridians, title):
    ...
    m.drawparallels(parallels, labels=[1,0,0,0], ax = ax, rotation=30, fontsize=8, linewidth=0)
    m.drawmeridians(meridians, labels=[0,0,0,1], ax = ax, rotation=30, fontsize=8, linewidth=0)
...
fig.tight_layout()
file_name = 'matrix_map_0_4_26_hcld'
