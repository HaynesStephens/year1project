...
def quiverPlot(col, ax, tit_ad, num_files = 10, filetype='oijl', unit_conv=0.1, depth=0):
    ...
    m.quiver(x, y, u, v, ax=ax, width=0.001, headwidth=5, headlength=4)
...
quiverPlot(col_22, ax, 'Air Surface Velocity', filetype='aij', unit_conv=1, depth=None)

fig.tight_layout(w_pad = 2.25)
file_name = 'plots/quiver_22p_a'
